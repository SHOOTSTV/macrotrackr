...
export function MealSearchFavorites() {
  ...
  async function logNow(result: MealSearchResult, override?: EditDraft) {
    setError(null);
  ...
  return (
    <Card className="space-y-3">
      ...
      {!shouldShowResults ? <p className="text-sm text-slate-500">Search your meals...</p> : null}
          ...
          return (
            <div key={itemKey} className="rounded-xl border border-slate-200 bg-white/80 p-3">
              ...
              <div className="mt-2 flex gap-2">
                <Button
                  type="button"
                  onClick={() => void logNow(result, isEditing ? editDraft ?? undefined : undefined)}
                >
                  Log now
                </Button>
                <Button
